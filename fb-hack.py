...
import exec os,sys,time,datetime,random,hashlib,re,threading,json,urllib,cookielib,requests,mechanize
...
def keluar():
    print "\033[1;96m[!]         \x1b[1;91mBixid"
    os.sys.exit()
...
\033[1;93m[¤] \x1b[0;31mFACEBOOK \x1b[1;96m  
