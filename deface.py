...
m3 = """</title>
    <meta charset="UTF-8">
    <meta name="Author" content="MR.K3DU4"/>
    <meta name="copyright" content="MR.K3DU4"/>
    <meta name="description" content="Reedit By MR.K3DU4"/>
    ...
    <meta property="og:image" content="">
        <style type="text/css">
            body {
                overflow:hidden;
                background-image:url('https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRuKh2pHzPbAimDsxee3o-kI55H6R34bXtp71fz8OG1rUhkFnnGNfrhsDEU_A');
...
<div class="fot">
Invisible Troops TEAM [+] Dunsanak Cyber Security [+]"""
l1 = team
l2 = """</div>
</center>
</body>
...
file.write(l2)
print
print "Script anda berhasil dibuat dengan nama", namafile
print
print "Terima Kasih telah mencoba karya saya :)"
